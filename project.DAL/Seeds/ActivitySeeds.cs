...
public static class ActivitySeeds
{
    public static readonly ActivityEntity IJCConsultation = new()
    {
        ...
        Start = new DateTime(2024, 05, 14, 13, 00, 00),
        End = new DateTime(2024, 05, 14, 14, 00, 00),
        Room = Room.A01,
    ...
    public static readonly ActivityEntity IDSProject = new()
    {
        ...
        Start = new DateTime(2024, 05, 14, 10, 00, 00),
        End = new DateTime(2024, 05, 14, 11, 00, 00),
        Room = Room.Online,
    ...
    public static readonly ActivityEntity IISProject = new()
    {
        ...
        ActivityType = ActivityType.Project,
        Start = new DateTime(2024, 05, 15, 08, 00, 00),
        End = new DateTime(2024, 05, 15, 09, 00, 00),
        Room = Room.Online,
        SubjectId = SubjectSeeds.IIS.Id,
        Subject = SubjectSeeds.IIS,
        Name = "IIS Projekt",
